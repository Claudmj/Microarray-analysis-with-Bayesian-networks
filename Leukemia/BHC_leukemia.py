...
if __name__ == '__main__':
    ...
    hypers = {
        ...
        'nu_0': 7130.0,
        'kappa_0': 1.0,
        'lambda_0': np.eye(7128)
    }
    data_model = NormalInverseWishart(**hypers)

    #import data into a dataframe
    filename='leukemia_original.csv'
    ...
    asgn, _ = bhc(data, data_model, 100)
    ...
    #see this url: https://scikit-learn.org/stable/auto_examples/model_selection/plot_precision_recall.html
